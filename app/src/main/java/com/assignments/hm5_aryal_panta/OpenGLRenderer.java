...
package com.assignments.hm5_aryal_panta;
...
public class OpenGLRenderer implements Renderer {
    ...
    public OpenGLRenderer(Context context, Handler handler) {
        ...
        spinner = new Spinner(1.0f, 1.0f, 1.0f);
...
//        Log.v("x ","x="+ ((Activity)mContext).getWindow().getWindowManager().getDefaultDisplay().getWidth());
//        Log.v("y ","y="+ ((Activity)mContext).getWindow().getWindowManager().getDefaultDisplay().getHeight());
        return true;
    }
